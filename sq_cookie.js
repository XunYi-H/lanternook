...
*/
//书旗签到 https://ocean.shuqireader.com/api/activity/xapi/signin/v5/signInAction
if ($request && $request.url.indexOf("signInAction") >= 0 && $request.body.indexOf("position=501") >= 0 && $request.body.indexOf("signInType=1") >= 0) {
    ...
    if (bodyVal) $.setdata(bodyVal, 'shuqidailysign');
    $.log(`[${jsname}] 获取dailysignkey请求: 成功🎉,key: ${bodyVal}`);
    $.msg(`获取dailysignkey: 成功🎉`, ``);

}

//获取极速版签到 //jsdailysign https://ocean.shuqireader.com/api/activity/xapi/signin/v5/signInAction
...
if($request&&request.url.match(/\/api\/ad\/union\/sdk\/reward_video\/reward/)) {
	bodyVal = $request.body;
...
if($request&&request.url.match(/\/api\/prizecenter\/xapi\/prize\/manual\/receive/)) {
	bodyVal = $request.body;
...
//极速版书城 jsshucheng https://ocean.shuqireader.com/api/activity/v1/task/reward?sdk=12.0&ustatus=1&umidtoken=84BLopNLOns0ljV8WaQ%2B17sy4Q%2BNLOMs&net_env=wifi&placeid=111111&user_id=2940533611&sn=5982636230684E1DA86DF6AF7F9335030E2F394B&msv=10.0.0&brand=Apple&imei=0F288998BA2D1B3F53C717FD003379C762E698B7&appVer=1.0.5.0&manufacturer=Apple&session=eyJhbGciOiJIUzUxMiJ9..GqcRjF7l-uoRG4X1XzAV_dkJlAc4az-OgPQ5bP_dPz3XbW9_HpjxhyFW7nvkyrRlMXZ6APX6bvv8aHmm0vJ6Xw&statusBarHeight=20.000000&platform=116&ver=210331&mod=iPhone8&wh=750x1334&utype=vip&utdid=YS4xnN1UHCEDAPxXxcuL3qId&idfa=08A53849-3D58-417A-8484-7D10A9A3A125";
if ($request && $request.url.indexOf("activity") >= 0 && $request.url.indexOf("reward") >= 0 && $request.url.indexOf("session=") >= 0) {
